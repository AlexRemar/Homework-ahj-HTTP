# Работа с HTTP
 ...
 [![Build status](https://ci.appveyor.com/api/projects/status/swqfc8b0cng1qk06?svg=true)](https://ci.appveyor.com/project/AlexRemar/Homework-ahj-HTTP) [[Github Pages](https://AlexRemar.github.io/Homework-ahj-HTTP)]
